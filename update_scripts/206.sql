...
as 
	...
	select t1.evb3, t1.date from partition_view t1 
 ...
 if @kod_zdarzenia <> 38 
 begin 
	select t1.*, isnull(t2.zalaczony_silnik, 0) zalaczony_silnik from partition_view t1 
 ...
 begin 
	select t1.evb3, t1.evb1, t1.evb4, t1.evb5, t1.evb6, t1.evb7, t1.evb8, t1.evb9, t1.evb10, isnull(t2.zalaczony_silnik, 0) zalaczony_silnik, count(*) ile_razy, min(date) date from partition_view t1 
		left join #stan_pojazdu t2 on (t2.from_ <= t1.date and t2.to_ >= t1.date) 
