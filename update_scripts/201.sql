...
AS
SELECT     TOP 100 PERCENT dbo.partition_view.evb1, dbo.partition_view.evb2, dbo.partition_view.evb4, dbo.partition_view.evb9, dbo.partition_view.evb10, 
...
FROM         dbo.partition_view INNER JOIN
                      dbo.car ON dbo.partition_view.evb2 = dbo.car.id_car LEFT OUTER JOIN
